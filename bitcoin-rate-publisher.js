 ...
 */
function scheduleQuarterHourlyRuns() {
  // Run immediately on start
  console.log('Bitcoin Rate Publisher Started');
  console.log('Relay:', relay.url);
  console.log('Source:', bitcoin.api);
  ...
  setTimeout(() => {
    ...
    setInterval(run, bitcoin.schedule);
  }, msToNextQuarter);
}
...
if (require.main === module) {
  scheduleQuarterHourlyRuns();
}

module.exports = { fetchBitcoinRate, publishBitcoinRateToNostr };
